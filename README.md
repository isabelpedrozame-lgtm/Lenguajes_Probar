# Gestión de vehiculos y motos
- *El objetivo principal consiste en aplicar los conocimientos adquiridos sobre React.js y JavaScript moderno, desarrollando una solución web completa que refleje las buenas prácticas del entorno profesional.*
## Se puede aprender a
- *Comprender el ciclo de vida de los componentes en React*
- *Interactuar con servicios externos a través de peticiones HTTP (fetch API).*
- *Aplique la integración de Bootstrap y React-Bootstrap para construir interfaces atractivas y adaptables.*
